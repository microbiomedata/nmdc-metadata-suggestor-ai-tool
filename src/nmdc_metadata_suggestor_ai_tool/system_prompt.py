...
- The `id` field should be populated with a unique identifier if the sample record is associated with a specific input. This could look like an nmdc-bsm-xxxxxx or a a indexed record identifier.
